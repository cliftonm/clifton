...
namespace WebRouterService
{
	...
	/// </summary>
	public class WebRouterReceptor : IReceptor
	{
		public static Dictionary<string, RouteInfo> routes = new Dictionary<string, RouteInfo>();
		...
		public void Process(ISemanticProcessor proc, IMembrane membrane, Route route)
		{
			...
			if (routes.TryGetValue(searchRoute, out routeInfo))
			{
